...
pub use crate::config::definitions::{
    ...
    YGGDRASIL_ENABLE_MOJANG_ANTI_FEATURES_KEY, YGGDRASIL_ENABLE_PROFILE_KEY_KEY,
    YGGDRASIL_MAX_ACTIVE_TOKENS_KEY, YGGDRASIL_MAX_PROFILE_RENAMES_KEY,
    YGGDRASIL_MAX_PROFILES_PER_USER_KEY, YGGDRASIL_MAX_TEXTURE_PIXELS_KEY,
...
pub const DEFAULT_YGGDRASIL_ALLOW_MICROSOFT_PROFILE_TEXTURE_OVERRIDE: bool = true;
...
impl RuntimeYggdrasilPolicy {
    pub fn from_runtime_config(runtime_config: &RuntimeConfig) -> Self {
        ...
        Self {
            ...
            allow_microsoft_profile_texture_override: runtime_config.get_bool_or(
                YGGDRASIL_ALLOW_MICROSOFT_PROFILE_TEXTURE_OVERRIDE_KEY,
                DEFAULT_YGGDRASIL_ALLOW_MICROSOFT_PROFILE_TEXTURE_OVERRIDE,
            ),
